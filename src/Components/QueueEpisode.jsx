  ...
  return (
    <>
      <div className="episodeContainer">
        ...
        <ShowDescriptionBtn showDescription={showDescription} toggleDescription={toggleDescription}/>
          <QueueBtn
            icon={<FaTrash />}
        ...
        <EpisodeDescription description={episode.description} showDescription={showDescription}/>
      </div>
    </>
  );
};
